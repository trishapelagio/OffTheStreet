...
const adminOrderPendingController = {
	adminOrderPending: function(req,res){
		if(req.session.type=="admin"){
			db.findMany(Order, {status: "Pending"}, null, function(orders) {
				...
				db.findMany(User, null, null, function(results) {
					...
					res.render('admin-order-pending-page', {orders: x});
				})
			})
		}
		else{
...
module.exports = adminOrderPendingController;